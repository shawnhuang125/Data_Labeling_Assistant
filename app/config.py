...
UI_CONFIG = {
    ...
    "cuisine_type": {
        ...
        "options": [
            "亞洲料理", "日式料理", "韓式料理", "歐式料理", 
            "歐式料理", "美式料理", "中式料理", "四川菜","粵菜","湖南菜","山東菜",
            "淮揚菜","浙江菜","閩菜","安徽菜","台式料理","義式料理","法式料理",
            "德式料理","英式料理","墨西哥料理","泰式料理","馬來西亞料理",
            "新加坡料理","越南料理","印尼料理","貴州菜","西式料理","湖北菜",
            "未指定料理","港式料理","江蘇菜"
        ]
    },
    "flavor": {
    ...
    "review_labeled_level": {
        "review_labeled_level": "評論標記等級 (review_labeled_level)",
